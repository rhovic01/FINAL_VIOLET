...
<head>
    ...
    <style>
        ...
        .count-number {
            font-size: 75px;  /* Makes it 1.5 times larger than surrounding text */
            font-weight: bold;
            margin-left: 5px;
        }
        }
                ...
                <div class="report-section mb-5">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="5" class="text-end" style="font-size: 20px;">
                                        Total Items:
                                        <span class="count-number" style="font-size: 35px;"><strong><?= count($inventoryData) ?></strong> </span>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
                ...
                <div class="report-section">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="9" class="text-end" style="font-size: 20px;">
                                        Total Transactions:
                                        <span class="count-number" style="font-size: 35px;"><strong><?= count($inventoryData) ?></strong> </span>
                                    </td>
                                </tr>
